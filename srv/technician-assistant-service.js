        ...
        try {
            response = await gpt.post('/v1/responses', {
                ...
                instructions: [
                    ...
                    'Preserve applicable safety warnings and prerequisites when relevant to the question.',
                    'If the supplied passages do not answer the question, say that the available documentation does not provide the answer.',
                    'Respond concisely in natural plain text without Markdown, headings, tables or citation markers.',
