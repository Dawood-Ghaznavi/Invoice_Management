...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ReportsListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheReportsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheReportsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheReportsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheReportsListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheReportsListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheReportsListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheReportsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheReportsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheReportsListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheReportsObjectPageGenerated.iSeeThisPage();
        });
