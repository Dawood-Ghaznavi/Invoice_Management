...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("VisitorHistoryListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheVisitorHistoryListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheVisitorHistoryListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheVisitorHistoryListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheVisitorHistoryListGenerated.onTable(defaultTableId).iCheckRows();
        //     When.onTheVisitorHistoryListGenerated.onFilterBar().iChangeSearchField(undefined);
        //     Then.onTheVisitorHistoryListGenerated.onFilterBar().iCheckSearchField(undefined);
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheVisitorHistoryListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheVisitorHistoryListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheVisitorHistoryListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheVisitorHistoryObjectPageGenerated.iSeeThisPage();
        });
